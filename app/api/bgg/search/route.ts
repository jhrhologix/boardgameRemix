...
export async function GET(request: Request) {
  ...
  try {
    console.log('API route: searching for', { query, exactMatch, yearFilter })
    const results = await searchBGGGamesServer(query, { exactMatch, yearFilter: yearFilter || undefined })
